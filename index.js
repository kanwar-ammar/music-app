...
const mixtapeRoutes = require("./src/routes/mixtapeRoutes");
const userRoutes = require("./src/routes/userRoutes");
const spotifyRoutes = require("./src/routes/spotifyRoutes");
const deezerRoutes = require("./src/routes/deezerRoutes");
const appleRoutes = require("./src/routes/appleRoutes");
